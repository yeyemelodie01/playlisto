 ...
 */
final class Version20250922101435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE survey_answer (id INT AUTO_INCREMENT NOT NULL, submission_id INT DEFAULT NULL, question_id INT NOT NULL, option_id INT NOT NULL, INDEX IDX_F2D38249E1FD4933 (submission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE survey_submission (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, survey_id INT NOT NULL, deduced_mood VARCHAR(255) DEFAULT NULL, deduced_activity VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_9E7F50C4A76ED395 (user_id), UNIQUE INDEX uniq_survey_user (survey_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE user (id INT NOT NULL, username VARCHAR(255) NOT NULL, spotify_id VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649A905FC5C (spotify_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE survey_answer ADD CONSTRAINT FK_F2D38249E1FD4933 FOREIGN KEY (submission_id) REFERENCES survey_submission (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE survey_submission ADD CONSTRAINT FK_9E7F50C4A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)
        SQL);
        $this->addSql(<<<'SQL'
