 ...
 */
final class Version20250724072348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE answer ADD user_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_DADD4A25A76ED395 ON answer
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE answer DROP user_id
        SQL);
    }
}
